# =============================================================================
# COMPLETE OPERATION 1 - EXACT REPLICA OF Flash_Report.py
# This is the complete and exact replica of Operation 1 from the original script
# =============================================================================

print("="*80)
print("COMPLETE OPERATION 1 - EXACT REPLICA OF ORIGINAL Flash_Report.py")
print("="*80)

# PART 1: Data Filtering (EXACT REPLICA WITH CORRECTIONS)
print('='*60)
print('OPERATION 1: BOE Data Validation and Filtering')
print('='*60)

# Filter for SRC_SYS_KY in [2032, 2866, 2867] - EXACT MATCH TO ORIGINAL (FIXED!)
df_src = df[df['SRC_SYS_KY'].isin([2032, 2866, 2867])]
